...
{
    public enum GameCacheState { Empty, InProgress, Populated, Played, Unknown, Invalid }    public enum GameCachePlatform { WinPC, PS2, PS3, Xbox, X360, GameCube, Wii, Switch, PS4, InEligible };
